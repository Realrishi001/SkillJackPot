...
const Sidebar = () => {
  // Enhanced sidebar menu items with icons
  const SidebarItems = [
    { 
      name: 'Dashboard', 
      href: '/admindashboard',
    ...
    { 
      name: 'Add Super Distributor', 
      href: '/add-super-distributor',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  return (
    <aside className="w-64 min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 border-r border-slate-700 flex flex-col items-center py-8 shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 mb-8">
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-3 rounded-2xl shadow-xl mb-4 transform hover:scale-105 transition-transform duration-300">
          <Image src="/Logo.png" alt="Skill Jackpot Logo" width={170} height={80} className="select-none filter brightness-70" />
        </div>
      </div>
      ...
      {/* Navigation */}
      <nav className="relative z-10 w-full flex flex-col gap-2 px-4">
